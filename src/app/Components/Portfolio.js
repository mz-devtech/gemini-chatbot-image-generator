            ...
            <div className="w-[92%] mx-auto py-5 md:py-7 lg:py-10">
                <div className="flex flex-col lg:flex-row justify-between items-center w-full gap-6 lg:gap-0">
                    <div className='w-full lg:w-1/3'>
                        <h6 className='uppercase text-[#fdfdfd] font-bold text-xl leading-5 tracking-[0.9] opacity-100'>our portfolio</h6>
                    ...
                    <div className='w-full lg:flex-1 group'>
                        <p className="text-[#a9a7b0] text-xl font-medium opacity-50 group-hover:opacity-100 group-hover:text-[#fdfdfd] transition-all duration-300">
                    ...
                    <div className='flex w-full lg:w-1/3 justify-end'>
                        <span className='uppercase text-[#fdfdfd] font-bold text-xl leading-5 tracking-[0.9] opacity-100 flex items-center gap-2 whitespace-nowrap'>
                ...
                <div className="w-full flex flex-col lg:flex-row gap-10 mt-16">
                    <div className="w-full lg:w-[46%] relative h-[400px] lg:h-[700px] group overflow-hidden">
                        ...
                        <div className='absolute bottom-6 left-6 z-20 flex flex-col gap-2'>
                            <h1 className='text-[#fdfdfd] text-3xl lg:text-4xl font-bold bg-black inline-block rounded-lg px-6 py-3 w-fit opacity-0 -translate-x-12 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 ease-out'>
                                In the Jungle
                            </h1>
