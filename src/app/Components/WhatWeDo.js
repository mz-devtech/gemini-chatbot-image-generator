    ...
    return (
        <>
            <div className='py-3 lg:py-8 md:py-5'>
                <h6 className='uppercase text-center text-[#fdfdfd] font-bold text-xl leading-5 tracking-[0.9] opacity-100'>what we do</h6>
                ...
                >
                    ...
                    <p className='relative text-[#fdfdfd] lg:leading-[80px] text-3xl mx-6 lg:mt-9 mt-4 font-bold text-center lg:text-7xl lg:w-full opacity-50 hover:opacity-100 transition-opacity duration-300'>
                        Explore the power of AI development tools, crafted with brilliance, style, quality and creativity.
                    </p>
                </div>

                <h6 className='text-sm  lg:text-3xl text-[#fdfdfd] font-bold text-center lg:mt-8 mt-3'>Peter Bowman</h6>
                <p className='text-[#fdfdfd] text-center opacity-50 text-2xl '>
                    Creative Director</p>
                ...
                <div className='w-[100%] flex flex-wrap items-stretch justify-center gap-2 mt-5'>
                    {cards.map(({ id, Icon, title }) => (
                        ...
                        >
                            <div className="relative w-28 h-28 rounded-full border-2 border-[#6600ff] group-hover:border-[#fdfdfd] flex items-center justify-center transition-all duration-300">
                                <Icon className="w-14 h-14 text-[#6600ff] group-hover:text-[#fdfdfd] transition-all duration-300" />
                            </div>

                            <Link
                                href="#"
                                className="text-[#fdfdfd] text-center font-bold text-2xl"
                            >
                                {title}
                            </Link>

                            <p className="text-[#a9a7b0] text-xl font-medium text-center opacity-50 group-hover:opacity-100 group-hover:text-[#fdfdfd] transition-all duration-300">
